import { HIDDEN_PRODUCT_TAG, SHOPIFY_GRAPHQL_API_ENDPOINT, TAGS } from '@/integrations/constants'
import { isShopifyError } from '@/integrations/type-guards'
import { ensureStartsWith } from '@/integrations/utils'
...
const key = process.env.SHOPIFY_STOREFRONT_ACCESS_API_TOKEN!
