...
```tsx
<Image src="/product.jpg" alt="Product" aspectRatio={1} mobileSize="100vw" desktopSize="33vw" />
```

### With Custom Sizes

```tsx
<Image src="/banner.jpg" alt="Banner" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
```
