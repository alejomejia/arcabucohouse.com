...
type ProductSlideProps = {
  ...
  product: Product
  /** When true, wraps in slide-mask div and enables eager image loading */
  preload: boolean
}
 ...
 * Returns null if the product has no images. When preload is true, wraps
 ...
 * @param props.preload - When true: wraps in slide-mask, enables eager loading
 */
export function ProductSlide({ className, product, preload }: ProductSlideProps) {
