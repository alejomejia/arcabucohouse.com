...
import { createCartAndSetCookie, redirectToCheckout } from '@/components/features/cart/actions'
import { useCart } from '@/components/features/cart/cart-context'
import { DeleteItemButton } from '@/components/features/cart/delete-item-button'
import { EditItemQuantityButton } from '@/components/features/cart/edit-item-quantity-button'
import LoadingDots from '@/components/from-template/loading-dots'
  ...
  return (
    <div>
      <div className="flex items-center">
        <UnderlineButton onClick={openCart} aria-label="Open cart">
          <SplitText
            ref={cartRef}
            type="chars"
