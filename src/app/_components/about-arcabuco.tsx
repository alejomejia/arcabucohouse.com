  ...
  return (
    <section className="bg-secondary-50">
      <Grid className="py-16 lg:py-32 items-center bg-secondary-50">
        <h2 className="col-span-12 md:col-span-8 lg:col-start-3 lg:col-end-10 font-serif font-bold text-balance italic text-secondary-300 text-3xl lg:text-4xl">
        ...
        <div className="col-span-12 md:col-start-9 md:col-end-17 lg:col-start-13 lg:col-end-22 flex flex-col gap-6">
          <div className="flex flex-col gap-4 font-serif text-primary-base text-xl">
