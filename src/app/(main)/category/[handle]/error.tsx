...
/**
 * Route-segment error boundary for `(main)/category/[handle]/`. Renders a
 * graceful "couldn't load this category" message with a retry that calls
  ...
  return (
    <Container>
      <section className="min-h-[60vh] flex flex-col items-center justify-center gap-4 py-24 text-center text-zinc-700">
        <Text as="h1" className="text-3xl md:text-4xl">We couldn't load this category</Text>
        <Text preset="body" className="max-w-md text-zinc-500">
          The collection didn't come back in time. This is usually a
