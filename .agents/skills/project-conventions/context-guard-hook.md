...
- `src/components/effects/cinema-scroll/cinema-scroll.context.ts` — the
  canonical example. Read it once, then write yours from muscle memory.
- `src/components/ui/dialog/context.tsx` — same pattern, different feature.
